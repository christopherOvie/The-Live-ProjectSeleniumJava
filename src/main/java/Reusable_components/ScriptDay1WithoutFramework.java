...
public class ScriptDay1WithoutFramework {
	...
	public static boolean launchBrowser(String browser) {
		boolean flag = false;
		System.setProperty("browser.chrome.driver", "C:\\Users\\GOD\\eclipse-workspace\\TheLiveProject\\chromedriver.exe");
	...
	public static boolean loginActions(String username, String password) {
		boolean flag = false;
		try {
			ScriptDay1WithoutFramework.readLocators("login_username_txtbox_id").sendKeys(username);
			
			ScriptDay1WithoutFramework.readLocators("login_password_txtbox_name").sendKeys(password);
...
//			driver.findElement(By.name("password")).sendKeys(password);
			//Thread.sleep(2000);
			ScriptDay1WithoutFramework.readLocators("login_signIn_btn_xpath").click();
			//driver.findElement(By.xpath("//button[@type='submit']")).click();
			ScriptDay1WithoutFramework.readLocators("login_agreement_btn_xpath").click();
	...
	public static void elementHighlight(WebElement e2) throws InterruptedException {
		...
		js.executeScript("arguments[0].setAttribute('style', 'background:yellow;border:2px dashed blue');", e);
		Thread.sleep(300);
